        ...
        <div className='py-12 bg-gray-900'>
                    ...
                    <div key={course.id} className='flex justify-center'>
                        <BackgroundGradient className='flex flex-col rounded[22px] bg-zinc-900 overflow-hidden h-full max-w-sm'>
                         <div className='p-4 sm:p-6 flex flex-col items-center text-center flex-grow'>
                            ...
                            <p className='text-lg text-neutral-400 flex-grow'>{course.description}</p>{""}
            ...
            <div>
               <div className='mt-20 text-center'>
                <Link href={'/courses'} className='px-6 py-3 rounded-lg bg-green-400 text-white font-semibold'> view all courses
                </Link>
                </div> 
            </div>
        </div>
